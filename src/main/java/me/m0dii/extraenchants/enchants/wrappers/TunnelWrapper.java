...
public class TunnelWrapper extends CustomEnchantment {
    ...
    public void onTunnel(final TunnelEvent e) {
        ...
        int level = InventoryUtils.getEnchantLevel(ctx.toolUsed(), EEnchant.TUNNEL);
        ...
        if (level == 2) {
            ...
            destroy(p, source.getRelative(BlockFace.DOWN), ctx);
            destroy(p, opposite.getRelative(BlockFace.DOWN), ctx);
        }
    }
