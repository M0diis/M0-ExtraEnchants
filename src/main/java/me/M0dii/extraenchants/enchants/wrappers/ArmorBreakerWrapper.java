...
@Wrapper(name = "Armor Breaker", maxLvl = 1)
public class ArmorBreakerWrapper extends Enchantment {
    private final String name;
    private final int maxLvl;

    public ArmorBreakerWrapper(final String name, final int lvl) {
    ...
    public boolean canEnchantItem(final @NotNull ItemStack item) {
        return Enchantables.isAxe(item) || Enchantables.isSword(item);
    }
