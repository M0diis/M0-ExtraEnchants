...
@EnchantWrapper(name = "Essence Drain", maxLvl = 1)
public class EssenceDrain extends Enchantment {
    private final String name;
    private final int maxLvl;
    private final EEnchant enchant;

    public EssenceDrain(final String name, final int lvl, EEnchant enchant) {
