...
public class ExperienceMinerWrapper extends Enchantment {
    ...
    public ExperienceMinerWrapper(final String name, final int lvl) {
    ...
    public boolean conflictsWith(final Enchantment enchantment) {
        return enchantment.equals(Enchantment.SILK_TOUCH) || enchantment.equals(CustomEnchants.TELEPATHY);
    }
